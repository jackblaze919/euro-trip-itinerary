  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        type="search"
        inputMode="search"
        className="w-full rounded-xl bg-navy-800/60 border border-cream-100/10 pl-9 pr-9 py-2.5 text-[13px] text-cream-50 placeholder:text-cream-100/35 focus:outline-none focus:border-gold-500/60 focus:ring-1 focus:ring-gold-500/30"
      />
      {value && (
        <button
          onClick={() => onChange('')}
