...
export const ITINERARY = [
  ...
  },
  {
    ...
    price: 'Door / cheap',
    reserve: 'No',
    description: 'Disco / funk / dance-pop edits. Bright, vocal, danceable. Easy walk-in if energy is high.',
  ...
  },
  {
    ...
    price: 'Ticketed',
    reserve: 'Yes',
    description: 'Todd Terje / Kamma & Masalo lineage. The single best fit on the trip — disco, nu-disco, French touch, funky/vocal house energy.',
    musicFit: 'Strongest fit on the trip. Best fit: vocal UKG, 2-step, disco house, French touch, nu-disco, funky/vocal house, and bright danceable club music. The Brighter Days crew live in this lane.',
    genreTags: ['Nu-Disco', 'Disco House', 'French Touch', 'Funky House', 'Vocal House'],
...
export const BEST_OF = {
  budapest: {
    ...
    nightlife: [
      '1. City Park Sunset Grooves @ Pavilon Kert (Sat) — best safe daytime fit',
      '2. Pontoon — Lick the Click (Sat) — social riverside groove',
      '3. Pontoon — Sunday Sundown',
      '4. IN FLUX @ Kassa Boat — possible UKG/bass option, check lineup carefully (may lean heavier — 140/bass)',
    ],
    nightlifeNote: 'Best fit: Vocal UKG · 2-Step · French Touch · Nu-Disco · Funky / Vocal House. Rank IN FLUX above Pavilon/Pontoon ONLY if the lineup clearly has vocal UKG / 2-step / garage classics.',
  ...
  amsterdam: {
    ...
    nightlife: [
      '1. Brighter Days · Kamma & Masalo @ The Loft (Fri) — TOP fit',
      '2. Disco Dolly — bright disco / nu-disco backup',
      '3. Shelter — only if it\'s a house lineup',
    ],
    nightlifeNote: 'Amsterdam is probably the best city on this route for disco / nu-disco / garage-adjacent nights — if the lineup fits. Best fit: Vocal UKG · 2-Step · French Touch · Nu-Disco · Funky / Vocal House.',
