...
export const CITIES = [
  {
    ...
    dates: 'May 7 – May 11',
    nights: 4,
    accent: 'from-rose-500/40 via-fuchsia-500/30 to-amber-400/30',
    chip: 'bg-rose-500/15 text-rose-200 border-rose-400/30',
    tagline: 'Ruin bars, thermal baths, riverside house parties.',
  },
  {
    id: 'salzburg',
    name: 'Salzburg',
    ...
    dates: 'May 11 – May 12',
    nights: 1,
    accent: 'from-emerald-500/30 via-teal-500/30 to-sky-500/30',
    chip: 'bg-emerald-500/15 text-emerald-200 border-emerald-400/30',
    tagline: 'Fortress, brewery, alpine pit stop.',
  },
  {
    id: 'munich',
    name: 'Munich',
    ...
    dates: 'May 12 – May 14',
    nights: 2,
    accent: 'from-amber-500/30 via-orange-500/30 to-rose-500/30',
    chip: 'bg-amber-500/15 text-amber-200 border-amber-400/30',
    tagline: 'Beer halls, BMWs, English Garden.',
  },
  {
    id: 'amsterdam',
    name: 'Amsterdam',
    ...
    dates: 'May 14 – May 16',
    nights: 2,
    accent: 'from-indigo-500/30 via-violet-500/30 to-pink-500/30',
    chip: 'bg-indigo-500/15 text-indigo-200 border-indigo-400/30',
    tagline: 'Canals, breweries, the BEST house night.',
  },
];
...
export const BOOK_NOW = [
  {
    id: 'book-1',
    label: 'Budapest · Széchenyi Bath fast-track ticket',
    when: 'Fri May 8',
    url: searchLink('Szechenyi Bath online ticket fast track'),
  },
  {
    id: 'book-2',
    label: 'Budapest · Gettó Gulyás dinner reservation',
    when: 'Thu May 7',
    url: searchLink('Getto Gulyas Budapest reservation'),
  },
  {
    id: 'book-3',
    label: 'Budapest · Menza dinner reservation',
    when: 'Fri May 8',
    url: searchLink('Menza Budapest reservation'),
  },
  {
    id: 'book-4',
    label: 'Budapest · Mazel Tov lunch reservation',
    when: 'Sat May 9',
    url: searchLink('Mazel Tov Budapest reservation'),
  },
  {
    id: 'book-5',
    label: 'Budapest · Aether SOAKIN\' tickets (verify lineup first)',
    when: 'Fri May 8',
    url: searchLink('Aether Club Budapest SOAKIN tickets'),
  },
  {
    id: 'book-6',
    label: 'Budapest → Salzburg train (ÖBB / RegioJet)',
    when: 'Mon May 11',
    url: searchLink('OBB Budapest to Salzburg train tickets'),
  },
  {
    id: 'book-7',
    label: 'Stiegl-Brauwelt brewery tour',
    when: 'Tue May 12',
    url: searchLink('Stiegl Brauwelt tour booking'),
  },
  {
    id: 'book-8',
    label: 'Salzburg → Munich train / Bayern-Ticket',
    when: 'Tue May 12',
    url: searchLink('Bayern Ticket Salzburg Munich'),
  },
  {
    id: 'book-9',
    label: 'Munich · Augustiner-Keller dinner',
    when: 'Wed May 13',
    url: searchLink('Augustiner-Keller Munich reservation'),
  },
  {
    id: 'book-10',
    label: 'Munich → Amsterdam flight',
    when: 'Thu May 14',
    url: searchLink('Munich to Amsterdam flight'),
  },
  {
    id: 'book-11',
    label: 'Amsterdam · Sampurna dinner',
    when: 'Thu May 14',
    url: searchLink('Sampurna Amsterdam reservation'),
  },
  {
    id: 'book-12',
    label: 'Amsterdam · Brighter Days @ The Loft tickets',
    when: 'Fri May 15',
    url: searchLink('Brighter Days Kamma Masalo The Loft Amsterdam tickets'),
  },
];
